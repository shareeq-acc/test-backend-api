...
const configSchema = z.object({
  ...
  // JWT Configuration (always present, optional when AUTH_JWT is disabled)
  ...
  SESSION_DRIVER: z.enum(['mongo', 'redis']).default('redis'),
  ...
  // OAuth and OTP Configuration (always present, optional when AUTH is disabled)
  ...
  // Observability Configuration (always present, optional when OBSERVABILITY_FULL is disabled)
